...
public class LeftScaleAutoMode extends AutoModeBase {
	
	public LeftScaleAutoMode() {
    ...
    public Routine getRoutine() {
        ...
        if(needsToCross) {
            ...
            initialPath.add(new Waypoint(new Translation2d(0, AutoDistances.kDistAcrossScale), 0.0));
        }
        else {
