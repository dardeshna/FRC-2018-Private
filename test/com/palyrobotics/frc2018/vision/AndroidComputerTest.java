...
public class AndroidComputerTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//
		////System.out.println(String.format("X: %b, Y: %b", VisionData.getXData().exists(),
		//VisionData.getZData().exists()));
		////
		//final String x = Double.toString(VisionData.getXDataValue()), y =
		//Double.toString(VisionData.getZDataValue());
		//
